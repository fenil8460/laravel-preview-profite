    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" style="font-weight: 600;">Add New Post</h4>
            </div>
            <div class="modal-body">
                {{ Form::open(array('url'=>route('admin.save'), 'method'=>'post', 'id'=>'create_resource_form', 'class'=>'form-horizontal', 'onsubmit'=>'return false;')) }}
                    <div class="form-group">
                        <div class="col-md-4">
                            {{ Form::label('title', 'Title') }}
                            {{ Form::text('title', '', array('id'=>'title', 'class'=>'form-control', 'autofocus'=>true, 'placeholder'=>'post title')) }}
                            <p id="title-error" class="hide" style="color: red;"></p>
                        </div>
                        <div class="col-md-4">
                            {{ Form::label('content', 'Content') }}
                            {{ Form::text('content', '', array('id'=>'content', 'class'=>'form-control', 'placeholder'=>'content')) }}
